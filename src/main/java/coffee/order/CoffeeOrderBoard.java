...
public class CoffeeOrderBoard {
    ...
    public void add(String nameCustomer, String...orders) {
        LOGGER.info("The work of the method add");
        try {
    ...
    public Order deliver() {
        LOGGER.info("The work of the method deliver");
    ...
    public Order deliver(int idOrder) {
        LOGGER.info("The work of the method deliver by id Order");
    ...
    public void draw() {
        LOGGER.info("The work of the method draw");
